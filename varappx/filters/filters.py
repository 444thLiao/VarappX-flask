...
from varappx.data_models.variants import VariantsCollection, Variant, VARIANT_FIELDS
from varappx.variants.genotypes_service import genotypes_service
from varappx.variants.variants_factory import namedtuples, extract_variants_from_ids_bin_array
...
class VariantFilter(Filter):
    ...
    def apply(self, db=None, initqs=None, limit=None, offset=0):
        ...
        :rtype: FilterResult"""
        if initqs is None:
            Variant.__table__.info['bind_ket'] = db
            initqs = Variant
